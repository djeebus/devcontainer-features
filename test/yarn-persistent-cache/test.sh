...
check "validate environment variable is set" test -n "$YARN_CACHE_FOLDER"
check "validate environment variable is set to mountpoint" test "$YARN_CACHE_FOLDER" = "$mountpoint"
